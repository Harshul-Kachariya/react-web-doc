    ...
    <div className="flex justify-center items-start ">
      <div className=" p-8 w-3/4">
        ...
        <p className="text-xl mb-4 w-[80%]">
          <span className="text-red-500"> memo</span> lets you skip re-rendering
          a component when its props are unchanged.
        </p>
        ...
        <div className="mt-5">
          <p className="text-xl mb-2 ">
            Wrap a component in <span className="text-red-500"> memo</span> to
            get a memoized version of that component. This memoized version of
            your component will usually not be re-rendered when its parent
            component is re-rendered as long as its props have not changed. But
            React may still re-render it: memoization is a performance
  ...
  // ...
      ...
      `}
          ...
          <div className="mt-5">
            ...
            <p className="text-xl mb-2 ">
              <strong className="text-red-500"> Component: </strong> The
              component that you want to memoize. The memo does not modify this
              component, but returns a new, memoized component instead. Any
              valid React component, including functions and forwardRef
              components, is accepted.
            </p>
            <p className="text-xl mb-2 ">
              <strong className="text-red-500"> optional arePropsEqual:</strong>{" "}
              A function that accepts two arguments: the component’s previous
              props, and its new props. It should return true if the old and new
              props are equal: that is, if the component will render the same
              output and behave in the same way with the new props as with the
              old. Otherwise it should return false. Usually, you will not
              specify this function. By default, React will compare each prop
              with Object.is.
            </p>
          ...
          <p className="text-xl mb-2 ">
            React normally re-renders a component whenever its parent
            re-renders. With memo, you can create a component that React will
            not re-render when its parent re-renders so long as its new props
            are the same as the old props. Such a component is said to be
            memoized.
          </p>
          <p className="text-xl mb-2 ">
